...
.animatedcontent a:hover {
    transform: translateY(-8px);
    box-shadow: 0 10px 20px rgba(0, 0, 0, 0.2);
}

.animatedcontent a img {
    position: absolute;
    cursor: pointer;
    /* 图像绝对定位，相对于父容器 */
    top: 0;
...
.animatedcontent a:hover span {
    display: flex;
}

.animatedcontent a:hover span .star {
    margin-left: 10%;
}

.animatedcontent a:hover span .download {
    margin-left: 10%;
}
</style>
